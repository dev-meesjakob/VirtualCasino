...
public class Reel {
    ...
    public void createFrontIcons() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (rdm1 < 15) {rdm2 = 0;}
            else if (rdm1 < 30) {rdm2 = 5;}
            else if (rdm1 < 50) {rdm2 = 2;}
            else if (rdm1 < 70) {rdm2 = 6;}
            else if (rdm1 < 90) {rdm2 = 9;}
            else if (rdm1 < 102) {rdm2 = 1;}
            else if (rdm1 < 110) {rdm2 = 3;}
            else if (rdm1 < 114) {rdm2 = 4;}
            else if (rdm1 < 116) {rdm2 = 7;}
            else {rdm2 = 8;}
